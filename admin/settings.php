...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $settings_to_update = [
        ...
        'esp8266_device_ip' => $_POST['esp8266_ip'] ?? '',
...
$esp8266_ip = $settings['esp8266_device_ip'] ?? '192.168.1.100';
...
<form method="POST" class="row">
    ...
    <div class="col-lg-12 mb-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-fingerprint"></i> Fingerprint Scanner Settings</h5>
            </div>
            <div class="card-body">
                <div class="mb-3">
                    <label for="esp8266_ip" class="form-label">ESP8266 Device IP Address</label>
                    <p class="form-text text-muted small">IP address of the fingerprint scanner (e.g., 192.168.1.100)</p>
                    <input type="text" class="form-control" id="esp8266_ip" name="esp8266_ip"
                           value="<?php echo $esp8266_ip; ?>" placeholder="192.168.1.100">
                </div>
            </div>
        </div>
    </div>
